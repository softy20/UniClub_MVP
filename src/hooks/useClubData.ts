 ...
 *
 * 📌 주요 기능:
 * - 앱이 처음 열릴 때 서버(Netlify 함수)에서 최신 동아리 데이터를 가져옵니다.
 ...
 * const { data, loading, applyClubData, patchEvent } = useClubData(seed);
 * ```
 *
 * 🎯 주요 관리 요소:
 ...
 *
 * 💡 팁 및 주의사항:
 * - 서버 통신은 "/.netlify/functions/club-data" 주소로 이루어집니다.
